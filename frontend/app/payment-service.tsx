 ...
 * Service payments use Stripe Checkout redirect (allowed by Apple for physical services)
 */
...
export default function PaymentServiceScreen() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await api.post('/services/create-stripe-checkout', {
      ...
      <LinearGradient colors={['#6C1110', '#8B1A19']} style={styles.header}>
        <SafeAreaView edges={['top']}>
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerTitle}>Pagar Servicio</Text>
            <View style={{ width: 40 }} />
          </View>
        </SafeAreaView>
      </LinearGradient>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <View style={styles.summaryCard}>
          <View style={styles.serviceHeader}>
            <Ionicons name="briefcase" size={48} color="#6C1110" />
...
const styles = StyleSheet.create({
  ...
  serviceHeader: { alignItems: 'center', marginBottom: 16 },
  serviceName: { fontSize: 18, fontWeight: '600', color: '#374151', marginTop: 12, textAlign: 'center' },
