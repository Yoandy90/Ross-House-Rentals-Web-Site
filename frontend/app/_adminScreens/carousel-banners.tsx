...
export default function CarouselBannersScreen() {
  ...
  const fetchBanners = useCallback(async () => {
    try {
      const response = await api.get('/admin/carousel-banners');
  ...
  const handleToggle = async (bannerId: string) => {
    try {
      setSaving(true);
      await api.patch(`/admin/carousel-banners/${bannerId}/toggle`);
      await fetchBanners();
    } catch (error: any) {
      ...
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              setSaving(true);
              await api.delete(`/admin/carousel-banners/${banner.id}`);
              await fetchBanners();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingBanner) {
        await api.put(`/admin/carousel-banners/${editingBanner.id}`, bannerData);
        Alert.alert('Éxito', 'Banner actualizado');
      } else {
        await api.post('/admin/carousel-banners', bannerData);
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder={t('admin.bannerTitlePlaceholder', 'Ej: Promoción Especial')}
            ...
            <TextInput
              ...
              placeholder={t('admin.bannerDescPlaceholder', 'Descripción opcional...')}
              placeholderTextColor="#9CA3AF"
              multiline
            />
            ...
            <TextInput
              ...
              placeholder={t('admin.bannerCtaPlaceholder', 'Ej: Ver más')}
              placeholderTextColor="#9CA3AF"
            />
